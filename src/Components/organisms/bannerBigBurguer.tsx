...
export default function BannerBigBurger () {
    ...
    const common = {alt: 'bannerBurguer', priority: true, fill: true};
    ...
    return(
        <>
        <div className='bg-white w-full grid grid-cols-1 md:grid-cols-2 items-center gap-6 border border-red-500'>
            {/* Text */}
            ...
            <div className='order-1 md:order-2 relative w-full h-[450px] md:h-[250px]'>
                <picture className='w-full h-full block'>
                    ...
                    <source media="(min-width: 767px)" srcSet={mobilSrc} />
                    <img {...rest} className='w-full h-full object-contain'/>
                </picture>
            </div>
